...
function done(err, res) {
    ...
    if (err) {
        ...
        document.getElementById('user').innerHTML = 'Error logging in! Try clearing your browser cache (refresh this window)';
        document.getElementById('user').style.display = 'block';
        alert("Error logging in! Try clearing your browser cache (refresh this window)\nYou need to refresh page to be able to log in.");
        return;
    }
    ...
    var o = {
        ...
        api_server: "<a href=\""+osm_server+"\" target=\"_blank\">"+osm_server.replace('openstreetmap','osm').replace('https://','')+"</a>"
    };
